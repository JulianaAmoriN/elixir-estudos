defmodule App.CLI.Menu.Choice do
  alias Mix.Shell.IO, as: Shell
  alias App.CLI.Menu.Intens
  alias App.DB.CSV
  ...
  defp generate_question(options) do
    ...
    "Digite a opção escolhida: [#{options}]\n"
  end
  ...
  defp invalid_option do
    ...
    Shell.prompt("Presseione ENTER para tentar novamente...")
    start()
  end
